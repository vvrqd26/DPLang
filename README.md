...
- [核心设计](dev_logs/1.核心设计.md)
- [语法参考](dev_logs/2.语法参考.md) - **已更新为下标索引语法**
- [完整示例](dev_logs/5.完整示例.md) - **已更新为下标索引语法**
- [内置函数参考](dev_logs/4.内置函数参考.md) - **已更新为下标索引语法**
- [解释器实现设计](dev_logs/7.解释器实现设计.md)
